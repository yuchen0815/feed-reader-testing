...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         * 页面看看会发生什么。
        */
        it('保证allFeeds变量被定义了而且不是空的', function() {
            //测试allFeeds变量被定义了
   ...
   describe('The menu',function(){
        ...
        it('菜单元素默认是隐藏的',function() {
         ...
         it('菜单图标被点击的时候菜单会切换可见状态',function() {
            ...
            //body不含有'menu-hidden'类时，点击图标菜单隐藏
            expect($('body').hasClass('menu-hidden')).toBe(false);
            // 第二次点击菜单图标
            $('.menu-icon-link').click();
            //body含有'menu-hidden'类时，点击图标菜单显示
    ...
    describe('Initial Entries', function(){
         ...
         */
         ...
         it('.feed 容器元素里面至少有一个 .entry 元素', function() {
    ...
    describe('New Feed Selection', function(){
        ...
        it('当loadFeed函数加载新源时内容真的会改变', function(done) {
